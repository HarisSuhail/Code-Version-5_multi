...
R_min_downlink = logspace(-1, 8, 30); % minimum rate is 1 Mbps
...
plotable_uplink_complete_rate = 0;
plotable_uplink_complete_rate_ND = 0;
...
for p = 1 : length(R_min_downlink)
    display(strcat('R_min_downlink = ', num2str(R_min_downlink(p))));
    ...
    temp_total_rate_uplink = 0;
    temp_total_rate_uplink_ND = 0;
    ...
    for j = 1:Niterations
        ...
        [nBS_0, nBS_1, nBS_2, BSType, BSLocation] = deployBS(area, UHFM_intensity, ratio, mmtoUHFFactor);
        ...
        [nU_BS_0_downlink, nU_BS_1_downlink, nU_BS_2_downlink, Pr_dB_downlink, power_dB_downlink, L_dB_downlink, d, association_matrix_downlink, tier_per_user_downlink, BS_associated_downlink]...
            = downlinkUserAssociation(U, nU, Pt_dB_downlink, nBS_0, nBS_1, nBS_2, BSType, BSLocation, blocking_prob);
        ...
        [Pt_dB_downlink_new] = downlinkPowerControl(U, nU, nBS_0, nBS_1, nBS_2, BSType, BSLocation, association_matrix_downlink, Pt_dB_downlink, Interference_threshold_dB_downlink, channel_dB, blocking_prob);
        
        
        
        
        %Get received power
        [Pr_dB_downlink, power_dB_downlink] = getNewReceivedPower(Pt_dB_downlink_new, association_matrix_downlink, U, nU, BSLocation, BSType, nBS_0, nBS_1, nBS_2, channel_dB, blocking_prob);
...
%         end
        ...
        [BS_associated_uplink, nU_BS_0_uplink, nU_BS_1_uplink, nU_BS_2_uplink, association_matrix_uplink,  Pr_dB_uplink, max_power_db ]...
            = uplinkUserAssociation( Pt_dB_uplink, U, nU, nBS_0, nBS_1, nBS_2, BSType, BSLocation,blocking_prob);
        
        %Power Control
        Pt_dB_uplink_new = Pt_dB_uplink;%
        [Pt_dB_uplink_new] = uplinkPowerControl(U, nU, nBS_0, nBS_1, nBS_2, BSType, BSLocation, association_matrix_uplink, Pt_dB_uplink, Interference_threshold_dB_uplink, channel_dB, blocking_prob);
        
        %Get received power
        [Pr_dB_uplink_new, power_dB_uplink]...
            = getNewReceivedPower(transpose(Pt_dB_uplink_new), association_matrix_uplink, U, nU, BSLocation, BSType, nBS_0, nBS_1, nBS_2, channel_dB, blocking_prob);
        ...
        temp_total_rate_uplink = temp_total_rate_uplink + sum(rate_uplink);
        ...
        [Pt_dB_uplink_new_ND] = uplinkPowerControl(U, nU, nBS_0, nBS_1, nBS_2, BSType, BSLocation, association_matrix_uplink_ND, Pt_dB_uplink_ND, Interference_threshold_dB_uplink, channel_dB, blocking_prob);
        ...
        [Pr_dB_uplink_new_ND, power_dB_uplink_ND]...
            = getNewReceivedPower(transpose(Pt_dB_uplink_new_ND), association_matrix_uplink_ND, U, nU, BSLocation, BSType, nBS_0, nBS_1, nBS_2, channel_dB, blocking_prob);
        ...
        temp_total_rate_uplink_ND = temp_total_rate_uplink_ND + sum(rate_uplink_ND);
    ...
    clc
    display(strcat('Percent Completion:  ', strcat(num2str(ceil(100*p/length(R_min_downlink)))),'%'));
    ...
    %----------
    plotable_uplink_complete_rate(p) = temp_total_rate_uplink/Niterations;
plotable_uplink_complete_rate_ND(p) = temp_total_rate_uplink_ND/Niterations;
...
if PC
figure;
semilogx(xvar, plotable_tier0_coverage_downlink, 'r');
title('Coverage Probability - Downlink '); xlabel('l_s / l_u_h_f'); ylabel('Coverage Probability');
hold on;
semilogx(xvar, plotable_tier1_coverage_downlink, 'g');
semilogx(xvar, plotable_tier2_coverage_downlink, 'k');
semilogx(xvar, plotable_system_coverage_downlink, 'm');
legend('UHF Macro', 'mmWave Small', 'UHF Small', 'Overall');

figure;
semilogx(xvar, plotable_sum_rate_downlink, 'r');
title('Rate - Downlink');
xlabel('l_s / l_u_h_f');
ylabel('Rate(bps)');
...
title('Rate - Downlink');
hold on
semilogx(xvar, plotable_tier0_sum_rate_downlink, 'g');
semilogx(xvar, plotable_tier1_sum_rate_downlink, 'k');
semilogx(xvar, plotable_tier2_sum_rate_downlink, 'm');
...
title('Systemrate - Uplink ^ ');
xlabel('l_s / l_u_h_f');
ylabel('System rate');
semilogx(xvar, plotable_uplink_complete_rate.*plotable_system_coverage_uplink, 'g--^');
semilogx(xvar, plotable_uplink_complete_rate_ND.*plotable_system_coverage_uplink_ND, 'k--<');

legend('Uplink rate decoupled', 'Uplink rate coupled');

figure;
hold on
semilogx(xvar, plotable_tier0_coverage_uplink, 'r--*');
title('Coverage Probability - Uplink ');
xlabel('l_s / l_u_h_f');
ylabel('Coverage Probability');
semilogx(xvar, plotable_tier1_coverage_uplink, 'g--^');
semilogx(xvar, plotable_tier2_coverage_uplink, 'k--<');
semilogx(xvar, plotable_system_coverage_uplink, 'm-->');
semilogx(xvar, plotable_tier0_coverage_uplink_ND, 'r:s');
semilogx(xvar, plotable_tier1_coverage_uplink_ND, 'g:d');
semilogx(xvar, plotable_tier2_coverage_uplink_ND, 'k:h');
semilogx(xvar, plotable_system_coverage_uplink_ND, 'm:p');
legend('UHF Macro', 'mmWave Small', 'UHF Small', 'Overall', 'UHF Macro ND', 'mmWave Small ND', 'UHF Small ND', 'Overall ND');

figure;
semilogx(xvar, plotable_system_coverage, 'm--s');hold on
semilogx(xvar, plotable_system_coverage_ND, 'm--d');
title('System Coverage');
xlabel('l_s / l_u_h_f');
legend('Decoupled','Non decoupled')
figure;
hold on
semilogx(xvar, plotable_sum_rate_uplink, 'r-s'); hold on
semilogx(xvar, plotable_sum_rate_uplink_ND, 'g-d');
...
figure;
hold on
semilogx(xvar, plotable_tier0_sum_rate_uplink, 'g');
hold on
semilogx(xvar, plotable_tier1_sum_rate_uplink, 'k');
semilogx(xvar, plotable_tier2_sum_rate_uplink, 'm');
semilogx(xvar, plotable_tier0_sum_rate_uplink_ND, 'g--d');
semilogx(xvar, plotable_tier1_sum_rate_uplink_ND, 'k--*');
semilogx(xvar, plotable_tier2_sum_rate_uplink_ND, 'm--s');
...
figure;
semilogx(xvar, plotable_coupled_users_fraction, ratio, plotable_decoupled_users_fraction);
title('Decoupling');
xlabel('l_s / l_u_h_f');
...
plotable_rate_other_type= plotable_uplink_complete_rate.*plotable_system_coverage_uplink;

save(strcat(general_filename, 'plotable_rate_other_type.mat'), 'plotable_rate_other_type');

plotable_rate_other_type_ND= plotable_uplink_complete_rate_ND.*plotable_system_coverage_uplink_ND;

save(strcat(general_filename, 'plotable_rate_other_type_ND.mat'), 'plotable_rate_other_type_ND');
