function [ P ] = downlinkPowerControl(U, nU, nBS_0, nBS_1, nBS_2, BSType, BSLocation, association_matrix_downlink, Pt_dB_downlink, Interference_threshold_dB, channel_dB, blocking_prob)
...
%    L_dB(u, :) = getPathLoss(BSType, l(u, :));
    ...
    PL(u) = getPathLoss(BSType(nearest_interfering_BS(u)), min_distance(u), blocking_prob);
