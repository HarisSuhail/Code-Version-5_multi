function [P] = uplinkPowerControl(U, nU, nBS_0, nBS_1, nBS_2, BSType, BSLocation, association_matrix_uplink, Pt_dB_uplink, Interference_threshold_dB_uplink, channel_dB, blocking_prob)
...
% %     end
    ...
    PL(b) = getPathLoss(BSType(b), min_distance, blocking_prob);
