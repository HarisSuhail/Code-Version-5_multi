...
for p = 1 : length(bias1)
    ...
    for j = 1:Niterations
        ...
        [nU_BS_0_downlink, nU_BS_1_downlink, nU_BS_2_downlink, Pr_dB_downlink, power_dB_downlink, L_dB_downlink, d, association_matrix_downlink, tier_per_user_downlink, BS_associated_downlink]...
            = downlinkUserAssociation(U, nU, Pt_dB_downlink, nBS_0, nBS_1, nBS_2, BSType, BSLocation, blocking_prob, bias0, bias1(p), bias2);
...
%         end
        ...
        [BS_associated_uplink, nU_BS_0_uplink, nU_BS_1_uplink, nU_BS_2_uplink, association_matrix_uplink,  Pr_dB_uplink, max_power_db ]...
            = uplinkUserAssociation(L_dB_downlink,Pt_dB_uplink, U, nU, nBS_0, nBS_1, nBS_2, BSType, BSLocation,blocking_prob, bias0, bias1(p), bias2);
...
if PC
figure;
plot(bias1, plotable_tier0_coverage_downlink, 'r');
title('Coverage Probability - Downlink '); xlabel('bias'); ylabel('Coverage Probability');
hold on;
plot(bias1, plotable_tier1_coverage_downlink, 'g');
plot(bias1, plotable_tier2_coverage_downlink, 'k');
plot(bias1, plotable_system_coverage_downlink, 'm');
legend('UHF Macro', 'mmWave Small', 'UHF Small', 'Overall');

figure;
plot(bias1, plotable_sum_rate_downlink, 'r');
title('Rate - Downlink');
xlabel('l_s / l_u_h_f');
ylabel('Rate(bps)');
...
xlabel('l_s / l_u_h_f');
ylabel('System rate');
plot(ratio, plotable_uplink_complete_rate.*plotable_system_coverage_uplink, 'g--^');
plot(ratio, plotable_uplink_complete_rate_ND.*plotable_system_coverage_uplink_ND, 'k--<');
...
save(strcat(general_filename, 'bias1.mat'), 'bias1');
